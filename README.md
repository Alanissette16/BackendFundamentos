...
![PageMetadatos](./src/assets/PageResponse(Metadatos).png)
2. **Slice response**: `GET /api/products/slice?page=0&size=5` sin totalElements
![Slice](./src/assets/SliceResponse.png)
3. **Filtros + paginación**: `GET /api/products/search?name=laptop&page=0&size=3`
![Filtros](./src/assets/Filtros+Page.png)
4. **Ordenamiento**: `GET /api/products?sort=price,desc&page=1&size=5`
![Precio desc](<./src/assets/Descendente Precios.png>)

## **9.3. Evidencias de performance**
1. **Comparación**: Tiempos de respuesta Page vs Slice

![Page 62.30ms](<./src/assets/Page Time.png>)
![Slice 41.40ms](<./src/assets/Slice Time.png>)

**Consultas de prueba con volumen**: para cada uno Page y Slice
1. Primera página de productos (page=0, size=10)
![Page 0](./src/assets/Page_1Volumen.png)
![Slice 0](./src/assets/Slice_1Volumen.png)
2. Página intermedia (page=5, size=10) 
![Page 5](./src/assets/Page_2Volumen.png)
![Slice 5](./src/assets/Slice_2Volumen.png)
3. Últimas páginas para verificar performance
![Page 99](./src/assets/Page_3Volumen.png)
![Slice 99](./src/assets/Slice_3Volumen.png)
4. Búsquedas con pocos y muchos resultados
![name drone](./src/assets/Drone148.png)
![name Laptop](./src/assets/Laptop3.png)
5. Ordenamiento por diferentes campos
![name,asc](./src/assets/Ordenamiento1.png)
# **10. Conclusiones**
...
# **Evidencias**
**del consumo de login**
![POST auth/login](./src/assets/login.png)
**register**
![POST /auth/register](./src/assets/register.png)
**api/users SIN TOKEN**
![GET api/users](./src/assets/api_users.png)